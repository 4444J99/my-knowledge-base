...
| Runtime probe automation for staging/prod | done (repo), pending (env execution) | `scripts/probe-search-runtime.ts`, `npm run probe:staging`, `npm run probe:prod` | run in target env with real credentials and archive reports |
...
- Strict readiness pass: `docs/evidence/runtime-probes/local-strict-readiness-20260210-154917.log`
- Parity + strict probe pass: `docs/evidence/runtime-probes/local-all-20260210-154945.json`
