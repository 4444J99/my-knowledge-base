...
,
  ...
  },
  {
    ...
    down: (db) => {
      db.exec(`
        DROP INDEX IF EXISTS idx_conversations_source_path;
        DROP INDEX IF EXISTS idx_conversations_provider_account_id;
        DROP INDEX IF EXISTS idx_conversations_provider_id;
        DROP INDEX IF EXISTS idx_ingest_runs_status;
        DROP INDEX IF EXISTS idx_ingest_runs_started;
        DROP INDEX IF EXISTS idx_thematic_edges_target;
        DROP INDEX IF EXISTS idx_thematic_edges_source;
        DROP INDEX IF EXISTS idx_term_occurrences_turn;
        DROP INDEX IF EXISTS idx_term_occurrences_thread;
        DROP INDEX IF EXISTS idx_term_occurrences_provider;
        DROP INDEX IF EXISTS idx_term_occurrences_lexicon;
        DROP INDEX IF EXISTS idx_term_lexicon_norm;
        DROP INDEX IF EXISTS idx_chat_turns_pair;
        DROP INDEX IF EXISTS idx_chat_turns_thread_index;
        DROP INDEX IF EXISTS idx_chat_threads_account;
        DROP INDEX IF EXISTS idx_chat_threads_provider;
        DROP INDEX IF EXISTS idx_provider_accounts_provider;
        DROP INDEX IF EXISTS idx_providers_provider_id;
        DROP TABLE IF EXISTS ingest_runs;
        DROP TABLE IF EXISTS thematic_edges;
        DROP TABLE IF EXISTS term_occurrences;
        DROP TABLE IF EXISTS term_lexicon;
